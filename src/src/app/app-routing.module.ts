...
const routes: Routes = [
  ...
  {path:'ResetPassword',component:Forgot3Component},
  ...
  {path:'passengerEntry/:flightId/:username/:source/:destination/:date/:noOfPassengers/:ticketId',component:PassengerEntryComponent,canActivate:[AuthGuardService]},
